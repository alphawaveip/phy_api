...
int aw_pmd_refclk_termination_get(mss_access_t *mss, aw_refclk_term_mode_t *lsrefbuf_term_mode);
...
int aw_pmd_tx_gen_config_set(mss_access_t *mss, aw_bist_pattern_t pattern, uint64_t user_defined_pattern);

 
int aw_pmd_tx_gen_config_get(mss_access_t *mss, aw_bist_pattern_t *pattern, uint64_t *user_defined_pattern);
...
int aw_pmd_tx_disable_pin_override_set(mss_access_t *mss, uint32_t override_enable);
...
int aw_pmd_tx_preset_get(mss_access_t *mss, aw_state_rate_t *tx_rate_preset, aw_training_mode_t *tx_training_mode);

 
int aw_pmd_rx_preset_get(mss_access_t *mss, aw_state_rate_t *rx_rate_preset, aw_training_mode_t *rx_training_mode);
...
int aw_pmd_lane_map_set(mss_access_t *mss, uint32_t const *tx_lane_map_arr, uint32_t const *rx_lane_map_arr);

 
int aw_pmd_lane_map_get(mss_access_t *mss, uint32_t *tx_lane_map_arr, uint32_t *rx_lane_map_arr);

 
int aw_pmd_uc_ucode_crc_clear(mss_access_t *mss);

 
int aw_pmd_uc_ucode_pmi_load(mss_access_t *mss, uint32_t **ucode_arr, uint32_t size);

 
int aw_pmd_uc_ucode_mdio_load(mss_access_t *mss, uint32_t **ucode_arr, uint32_t ucode_len);
